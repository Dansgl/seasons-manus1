...
var userRoleEnum, categoryEnum, ageRangeEnum, seasonEnum, inventoryStateEnum, subscriptionStatusEnum, boxStatusEnum, postStatusEnum, users, products, inventoryItems, subscriptions, boxes, boxItems, cartItems, swapItems, blogPosts, blogCategories, blogTags, postCategories, postTags;
var init_schema = __esm({
  "drizzle/schema.ts"() {
    ...
    seasonEnum = pgEnum("season", ["summer", "winter", "all-season"]);
    inventoryStateEnum = pgEnum("inventory_state", [
      "available",
      "active",
      "in_transit",
      "quarantine",
    ...
    boxStatusEnum = pgEnum("box_status", [
      "selecting",
      "confirmed",
      "shipped",
      "active",
    ...
    postStatusEnum = pgEnum("post_status", [
      "draft",
      "published",
      "archived"
    ]);
    ...
    postCategories = pgTable("post_categories", {
